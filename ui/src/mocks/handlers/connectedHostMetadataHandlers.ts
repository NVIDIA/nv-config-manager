...
export const connectedHostMetadataHandlers = [
  http.post(
    sanitizeUrl(`${apiURL}/v1/workflow/ngc/connected_host_metadata`),
    async ({ request }) => {
      const body =
        (await request.json()) as ConnectedDeviceMetadataWorkflowInput;
