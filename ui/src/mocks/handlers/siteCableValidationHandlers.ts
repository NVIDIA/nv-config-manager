...
export const siteCableValidationHandlers = [
  http.post(
    sanitizeUrl(`${apiURL}/v1/workflow/ngc/site_cable_validation`),
    async ({ request }) => {
      const body = (await request.json()) as SiteCableValidationWorkflowInput;
