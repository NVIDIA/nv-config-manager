...
import { ConfigDiffWorkflowInput } from "@/types/data-table.types";
...
const ConfigDiffWorkflowForm = () => {
  ...
  const onSubmit = async (data: DeviceWorkflowFormSchema) => {
    ...
    try {
      ...
      // Rethrow so DeviceWorkflowForm re-enables the form for another attempt.
      throw error;
    }
  };
  ...
  return (
    <DeviceWorkflowForm
      title="New Configuration Diff Workflow"
      onSubmit={onSubmit}
    />
  );
};

export default ConfigDiffWorkflowForm;
