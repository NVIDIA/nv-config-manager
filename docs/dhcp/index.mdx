...
The Config Manager splash page summarizes active leases, reservations, and pool utilization. Select the **Active leases**, **Reservations**, or **Pool usage** tab to inspect each view. You can also clear an active lease after confirming the action.
