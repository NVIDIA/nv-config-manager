...
- [AIR Simulation User Guide](user-guides/air-simulation/index.mdx) covers workflow validation in NVIDIA DSX Air.
- [I want to...](i-want-to.mdx) routes common tasks to the right guide.

<Warning>
The local development quick start is only for render and UI exploration. Use the AIR simulation guide when you need simulated Cumulus switches for device-facing workflow validation.
</Warning>
