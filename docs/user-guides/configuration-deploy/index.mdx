...
For fabric-wide changes across many devices, use [Multi-Device Deploy](../multi-deploy/index.mdx) instead. For tenant-scoped configuration changes that should run without human approval, use [Tenant Deploy](../tenant-deploy/index.mdx).
...
- [Tenant Deploy](../tenant-deploy/index.mdx) — tenant-scoped deploy with automated diff validation instead of human approval.
