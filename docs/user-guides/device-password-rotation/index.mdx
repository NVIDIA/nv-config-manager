...
- **Device exists in Nautobot** with a current intended configuration in the [Config Store](../../config-store/index.mdx), on a supported platform (Cumulus Linux or NVOS).
