...
- A local clone of your fork of the [Config Manager repository](https://github.com/NVIDIA/nv-config-manager). Keep the NVIDIA repository as an upstream remote when you need to sync release branches or compare against the source repo.
