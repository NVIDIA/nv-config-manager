...
The bundled NATS deployment creates the streams and durable consumers automatically. When NATS is owned outside the Config Manager deployment, coordinate the stream, consumer, account import, and user permissions with the NATS administrator.
