...
- `nv set/unset system aaa user <username> hashed-password` (Cumulus Linux/NVOS) or an `encrypted-password` change under `system login user <username> authentication` (Juniper Junos)
