...
1. **Serial Validation** - Device validates its serial number matches Nautobot records
...
1. Update the device's firmware version in Nautobot configuration context
