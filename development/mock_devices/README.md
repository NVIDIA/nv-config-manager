...
| **Secrets**             | HashiCorp Vault                     | `--sites DC01` generates mock K8s secrets (`root_password_r1`, etc.)                                                |
| **TLS certificates**    | Proper CA-signed certs                                               | Self-signed certs generated at Docker build time (`verify=False`)                                                   |
| **Topology**            | Real devices imported into Nautobot                       | Design Builder job creates devices from JSON fixtures                                                               |
